...
export function ExportButton({
  ...
  return (
    <button
      onClick={download}
      disabled={busy}
      className="inline-flex w-full items-center justify-between gap-3 rounded-md border border-white/10 bg-white/[0.02] px-4 py-3 text-sm text-offwhite transition hover:bg-white/[0.05] disabled:opacity-50"
    >
  ...
  return (
    ...
    >
      ...
      <input
        ...
        placeholder="DELETAR"
        className="num w-full rounded-md border border-white/10 bg-charcoal px-3 py-2 text-sm text-offwhite outline-none focus:border-rose-500/50"
      />
      <div className="flex gap-2">
        ...
        <button
          ...
          className="rounded-md border border-white/10 bg-white/[0.04] px-4 py-2 text-sm text-zinc-300 hover:bg-white/[0.08]"
        >
          Cancelar
        </button>
      </div>
